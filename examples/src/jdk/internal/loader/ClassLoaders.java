...
public class ClassLoaders {
    ...
    private static class BootClassLoader extends BuiltinClassLoader {
        BootClassLoader(URLClassPath bcp) {
            super(null, null, bcp);
            System.out.println("==> HotChocolate (BCL): initializing");
        }
        ...
        protected Class<?> findClass(String name) throws ClassNotFoundException {
            Class cl;
            try {
                System.out.printf("==> HotChocolate (BCL): findClass %s%n", name);
                cl = super.findClass(name);
                System.out.printf("<== HotChocolate (BCL): findClass %s OK%n", name);
            }
            catch (ClassNotFoundException cnfe) {
                System.out.printf("<== HotChocolate (BCL): findClass %s ClassNotFoundException%n", name);
                throw cnfe;
            }
            return cl;
        }
        ...
        protected Class<?> findClass(String mn, String cn) {
            Class cl;
            System.out.printf("==> HotChocolate (BCL): findClass %s:%s%n", mn, cn);
            cl = super.findClass(mn, cn);
            System.out.printf("<== HotChocolate (BCL): findClass %s:%s %s%n", mn, cn, (cl == null ? "NULL" : "OK"));
            return cl;
        }
        ...
        protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
            Class cl;
            try {
                System.out.printf("==> HotChocolate (BCL): loadClass %s%n", name);
                cl = super.loadClass(name, resolve);
                System.out.printf("<== HotChocolate (BCL): loadClass %s OK%n", name);
            }
            catch (ClassNotFoundException cnfe) {
                System.out.printf("<== HotChocolate (BCL): loadClass %s ClassNotFoundException%n", name);
                throw cnfe;
            }
            return cl;
        }
        ...
        protected Class<?> loadClassOrNull(String cn, boolean resolve) {
            System.out.print("==> HotChocolate (BCL): loadClassOrNull ");
            System.out.print(cn);
            System.out.println();
            Class c = JLA.findBootstrapClassOrNull(this, cn);
            System.out.print("<== HotChocolate (BCL): loadClassOrNull ");
            System.out.print(cn);
            System.out.println(((c == null) ? "NULL" : " OK"));
            return c;
        }
    };
    ...
    private static class PlatformClassLoader extends BuiltinClassLoader {
        ...
        PlatformClassLoader(BootClassLoader parent) {
            ...
            System.out.println("==> HotChocolate (PCL): initializing");
        }
        ...
        protected Class<?> findClass(String name) throws ClassNotFoundException {
            Class cl;
            try {
                System.out.printf("==> HotChocolate (PCL): findClass %s%n", name);
                cl = super.findClass(name);
                System.out.printf("<== HotChocolate (PCL): findClass %s OK%n", name);
            }
            catch (ClassNotFoundException cnfe) {
                System.out.printf("<== HotChocolate (PCL): findClass %s ClassNotFoundException%n", name);
                throw cnfe;
            }
            return cl;
        }
        ...
        protected Class<?> findClass(String mn, String cn) {
            Class cl;
            System.out.printf("==> HotChocolate (PCL): findClass %s:%s%n", mn, cn);
            cl = super.findClass(mn, cn);
            System.out.printf("<== HotChocolate (PCL): findClass %s:%s %s%n", mn, cn, (cl == null ? "NULL" : "OK"));
            return cl;
        }
        ...
        protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
            Class cl;
            try {
                System.out.printf("==> HotChocolate (PCL): loadClass %s%n", name);
                cl = super.loadClass(name, resolve);
                System.out.printf("<== HotChocolate (PCL): loadClass %s OK%n", name);
            }
            catch (ClassNotFoundException cnfe) {
                System.out.printf("<== HotChocolate (PCL): loadClass %s ClassNotFoundException%n", name);
                throw cnfe;
            }
            return cl;
        }
        ...
        @Override
        protected Class<?> loadClassOrNull(String cn, boolean resolve) {
            System.out.printf("==> HotChocolate (PCL): loadClassOrNull %s%n", cn);
            Class c = super.loadClassOrNull(cn, resolve);
            System.out.printf("<== HotChocolate (PCL): loadClassOrNull %s %s%n", cn, ((c == null) ? "NULL" : " OK"));
            return c;
        }
    }
    ...
    private static class AppClassLoader extends BuiltinClassLoader {
        ...
        AppClassLoader(BuiltinClassLoader parent, URLClassPath ucp) {
            ...
            System.out.println("==> HotChocolate (ACL): initializing");
        }
            ...
            throws ClassNotFoundException
        {
            ...
            Class cl;
            try {
                System.out.printf("==> HotChocolate (ACL): loadClass %s%n", cn);
                cl = super.loadClass(cn, resolve);
                System.out.printf("<== HotChocolate (ACL): loadClass %s OK%n", cn);
            }
            catch (ClassNotFoundException cnfe) {
                System.out.printf("<== HotChocolate (ACL): loadClass %s ClassNotFoundException%n", cn);
                throw cnfe;
            }
            return cl;
        }
        ...
        protected Class<?> findClass(String name) throws ClassNotFoundException {
            Class cl;
            try {
                System.out.printf("==> HotChocolate (ACL): findClass %s%n", name);
                cl = super.findClass(name);
                System.out.printf("<== HotChocolate (ACL): findClass %s OK%n", name);
            }
            catch (ClassNotFoundException cnfe) {
                System.out.printf("<== HotChocolate (ACL): findClass %s ClassNotFoundException%n", name);
                throw cnfe;
            }
            return cl;
        }
        ...
        protected Class<?> findClass(String mn, String cn) {
            Class cl;
            System.out.printf("==> HotChocolate (ACL): findClass %s:%s%n", mn, cn);
            cl = super.findClass(mn, cn);
            System.out.printf("<== HotChocolate (ACL): findClass %s:%s %s%n", mn, cn, (cl == null ? "NULL" : "OK"));
            return cl;
        }

        @Override
        protected Class<?> loadClassOrNull(String cn, boolean resolve) {
            System.out.printf("==> HotChocolate (ACL): loadClassOrNull %s%n", cn);
            Class c = super.loadClassOrNull(cn, resolve);
            System.out.printf("<== HotChocolate (ACL): loadClassOrNull %s %s%n", cn, ((c == null) ? "NULL" : " OK"));
            return c;
        }
