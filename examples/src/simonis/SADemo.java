...
public class SADemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 0 || "defineClass".equals(args[0])) {
            ...
            int count = getClassStats("simonis.SADemo");
            ...
            count = getClassStats("simonis.SADemo");
            ...
            MyClassLoader cl = new MyClassLoader();
            int index = getStringIndex("simonis/SADemo", buf);
            replaceString(buf, "java/simoni/SADemo", index);
            while ((index = getStringIndex("Lsimonis/SADemo;", buf, index + 1)) != 0) {
                replaceString(buf, "Ljava/simoni/SADemo;", index);
            }
            index = getStringIndex("simonis.SADemo", buf);
            replaceString(buf, "java.simoni.SADemo", index);
